...
namespace JobsJobsJobs.Controllers
{
    ...
    public class JobsJobsJobsApiController : JobsJobsJobsApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public JobsJobsJobsApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
